...
// ==========================================
// 1. PROJECTED VOLUME GRAPH GENERATOR
// ==========================================
const buildVolumeGraph = () => {
    ...
    // C. Calculate Volume Progression
    // Block 1 (Base)
    let w1 = 6.0;
    let w2 = w1 * 1.05;
    let w3 = w2 * 1.05;
    ...
    return `
        <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6 shadow-lg mb-10">
            ...
            <div class="text-slate-500 text-xs italic text-center mt-4">
...
// ==========================================
// 2. PHASE CHART GENERATOR (Gantt Style)
// ==========================================
const buildPhaseChart = (planMd) => {
    const phasesSection = Parser.getSection(planMd, "Periodization Phases");
    if (!phasesSection) return '<p class="text-slate-500">Phases not defined in plan.</p>';
    ...
    phases.forEach((p, index) => {
        // Determine if active (Basic date checking logic)
