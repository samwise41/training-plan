// js/views/gear/components.js
import { WEATHER_MAP } from './utils.js';

export const buildHourlyForecast = (hourlyWeather) => {
...
export const buildTempOptions = (defaultVal) => {
...
export const generateRow = (idPrefix, iconClass, label, colorClass) => `
...
export const renderLayout = (hourlyHtml, tempOptions, markdownContent) => {
